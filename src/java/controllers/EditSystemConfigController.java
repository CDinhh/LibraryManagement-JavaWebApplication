 ...
 * @author Dan Huy
 */
public class EditSystemConfigController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try{
            ...
            int result=D.updateConfig(id, key, value, des);
            if(result>0){
                request.setAttribute("Msg", "Saved");
                request.getRequestDispatcher("ViewSystemConfigController").forward(request, response);
            }else{
